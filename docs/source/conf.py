...
htmlhelp_basename = 'riskparitypydoc'
...
latex_documents = [
    (master_doc, 'riskparitypy.tex', 'riskparity.py Documentation',
     'Ze Vinicius and Daniel Palomar', 'manual'),
]
...
man_pages = [
    (master_doc, 'riskparitypy', 'riskparity.py Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'riskparitypy', 'riskparity.py Documentation',
     author, 'riskparitypy', 'One line description of project.',
     'Miscellaneous'),
]
